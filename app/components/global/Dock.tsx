...
function DockItem({
    ...
    return (
        <motion.div
            ...
            onClick={onClick}
            className={`cursor-pointer hover:bg-gray-900 hover:text-white relative inline-flex items-center justify-center rounded-full 
...
border border-gray-200 bg-white px-2 py-0.5 text-xs text-gray-900 font-bold shadow-sm`}
                    role="tooltip"
                    style={{ x: '-50%' }}
                >
                    {children}
